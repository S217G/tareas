...
class IntegratedApp:
    ...
    def _build_camera_panel(self, parent, title='Cámara / Detección'):
        ...
        self.cam_label = tk.Label(frame, text='Cam preview', width=40, height=15, anchor='center', relief=tk.SUNKEN)
            ...
            try:
                ...
                while self.cam_running:
                    ...
                    if self.model_yolo:
                        ...
                        results = self.model_yolo.predict(frame, conf=0.5, verbose=False)
                        # Dibujar automáticamente los cuadros y etiquetas (macho/hembra)
